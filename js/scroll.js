...
$(document).ready(function() {
    $('#link_1').click(function(){
       $('html, body').animate({scrollTop:$('#calculator_section').position().top - 50}, 1000);
    });
    $('#link_2').click(function(){
       $('html, body').animate({scrollTop:$('#about_us_section').position().top - 100}, 1000);
    });
    $('#link_3').click(function(){
       $('html, body').animate({scrollTop:$('#product_section').position().top - 150}, 1000);
    });
    $('#link_4').click(function(){
       $('html, body').animate({scrollTop:$('#calculator_section').position().top - 100}, 1000);
    });
    $('#link_5').click(function(){
       $('html, body').animate({scrollTop:$('#table_section').position().top - 150}, 1000);
    });
